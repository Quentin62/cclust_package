...
class CoclustPLBcem:
    ...
    def __init__(self, n_row_clusters=2, n_col_clusters=2, init=None, max_iter=100, n_init=1, tol=1e-9, random_state=None):
    ...
    def _fit_single(self, X, random_state, y=None):
        ...
        N = X.sum()
        const = 1.0 / (1.0 * N * N)  # safety parameter to avoid log(0) and  division by zero
        ...
        while change:
            ...
            # !!! gammakl has been transformed to a (non-subscriptable) COO matrix. Convert it back to CSR  FR 08-05-19
